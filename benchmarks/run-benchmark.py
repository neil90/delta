...
benchmarks = {
    ...
    "tpcds-10gb-parquet-load": ParquetTPCDSDataLoadSpec(scale_in_gb=10),
    "tpcds-100gb-parquet-load": ParquetTPCDSDataLoadSpec(scale_in_gb=100),
    "tpcds-1tb-parquet-load": ParquetTPCDSDataLoadSpec(scale_in_gb=1000),
    ...
    "tpcds-10gb-parquet": ParquetTPCDSBenchmarkSpec(scale_in_gb=10),
    "tpcds-100gb-parquet": ParquetTPCDSBenchmarkSpec(scale_in_gb=100),
    "tpcds-1tb-parquet": ParquetTPCDSBenchmarkSpec(scale_in_gb=1000),
